...
from config.loader import load_restaurant_configs, get_config_path
...
def main(polling_interval: int = 300):
    ...
    restaurants = load_restaurant_configs(config_path)
    
    # Access settings anywhere in your code
    api_url = settings.api.BASE_URL
    db_connection = settings.db.CONNECTION_STRING
